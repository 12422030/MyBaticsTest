...
public class TestCRUDByXmlMapper {
	...
	public void testAdd() {
		 ...
		 */
		String statement = "me.liwei.mapping.userMapper.addUser";// 映射sql的标识字符串
		User user = new User();
		user.setName("用户孤傲苍狼");
		user.setAge(20);
		// 执行插入操作
	...
	public void testUpdate() {
		 ...
		 */
		String statement = "me.liwei.mapping.userMapper.updateUser";// 映射sql的标识字符串
		User user = new User();
		user.setId(3);
		user.setName("孤傲苍狼");
		user.setAge(25);
	...
	public void testDelete() {
		 ...
		 */
		String statement = "me.liwei.mapping.userMapper.deleteUser";// 映射sql的标识字符串
		// 执行删除操作
	...
	public void testGetAll() {
		 ...
		 */
		String statement = "me.liwei.mapping.userMapper.getAllUsers";// 映射sql的标识字符串
